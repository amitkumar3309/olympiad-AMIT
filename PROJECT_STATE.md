...
_Last updated: 2026-08-12 (Milestone 8 — Daily Challenge, implemented and verified end-to-end)._
...
**Milestone 8 — Daily Challenge: implemented and verified end-to-end.** One question a day, per class: a student opens it, answers it once, and is marked immediately with the correct answer and the author's explanation, earning 15 XP for taking part. Staff can schedule days in advance from the published bank; a day nobody scheduled fills itself. Every attempt is persisted, and the reward cannot be claimed twice.
...
- **Journey map / Gallery / Notifications / Subscriptions** — not started. (**Mock tests** left this list in Milestone 7; the **Practice Zone** in Milestone 6; XP, Levels, Badges-as-Achievements, Streaks and the Leaderboard in Milestone 5.)
...
models/                   17 models, one file each (+ DailyChallenge,
...
**Owner decision: Milestone 9.** The strongest candidate remains **the official exam: `ExamAttempt` → `Result` → certificates**, and each milestone since Milestone 6 has made it shorter.
