...
_Last updated: 2026-08-13 (Milestone 9 — Gamification Engine, implemented and verified end-to-end)._
...
**Milestone 9 — Gamification Engine: implemented and verified end-to-end.** XP, levels, streaks and achievements were already real and derived by Milestones 5–8; this milestone did the four things genuinely missing.
...
- **Gallery / Notifications / Subscriptions** — not started. (The **journey map** left this list in Milestone 9; **mock tests** in Milestone 7; the **Practice Zone** in Milestone 6; XP, Levels, Badges-as-Achievements, Streaks and the Leaderboard in Milestone 5.)
...
**Owner decision: Milestone 10.** The strongest candidate remains **the official exam: `ExamAttempt` → `Result` → certificates**, and every milestone since Milestone 6 has made it shorter.
...
See [`DECISIONS.md`](DECISIONS.md). Milestone 9 added four: one reward engine that every grant goes through; badges as tiered families distinct from achievements; the journey map being ordered and measured on cumulative facts; and XP amounts being administrator-tunable while the rules stay in code.
